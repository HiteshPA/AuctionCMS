...
!function(a,b) {
	...
	(this,function() {
		...
		function c(a,b,c,d) {
			...
			return m[e] || (k.insertRule("@"+i+"keyframes "+e+"{
					0%{
						opacity:"+g+"}
						"+f+"%{
							opacity:"+a+"}
							"+(f+.01)+"%{
								...
								"+(f+b)%100+"%{
									...
									100%{
										...
										",k.cssRules.length),m[e] = 1),e}
		function d(a,b) {
			var c,d,e = a.style;
			if(b = b.charAt(0).toUpperCase()+b.slice(1),void 0! == e[b])return b;
			for(d = 0;
					d<l.length;
					d++)if(c = l[d]+b,void 0! == e[c])return c}
			function e(a,b) {
			...
			function i() {
				...
				k.addRule(".spin-vml","behavior:url(#default#VML)"),h.prototype.lines=function(a,d) {
					...
					if(d.shadow)for(i = 1;
							i< = d.lines;
							i++)h(i,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow = 1,shadowopacity = .3)");
					for(i = 1;
							i< = d.lines;
							i++)h(i);
					return b(a,m)}
				...
				spin:function(b) {
					...
					if(e(f,{
						position:d.position,width:0,zIndex:d.zIndex,left:d.left,top:d.top}
						    ...
						    !function o() {
							    ...
							    for(var a = 0;
								    a<d.lines;
								    a++)g = Math.max(1-(h+(d.lines-a)*n)%l*m,d.opacity),c.opacity(f,a*d.direction+i,g,d);
					...
					return c}
				     ...
				     ,lines:function(d,f) {
					     ...
					     for(var i,k = 0,l = (f.lines-1)*(1-f.direction)/2;
							     k<f.lines;
							     k++)i = e(a(),{
