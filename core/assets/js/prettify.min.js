			...
			if(b = a.regexLiterals) {
				...
				|\\? | @|\\[ | ~ | {
					|\\^\\^? = ?|\\|\\|? = ? | break | case | continue | delete | do | else | finally | instanceof | return | throw | try | typeof)\\s*("+("/(? = [^/*"+b+"])(?:[^/\\x5B\\x5C"+b+"]|\\x5C"+s+"|\\x5B(?:[^\\x5C\\x5D"+b+"]|\\x5C"+
						...
						p(C([],[["atv",/^[\S\s]+/]]),["uq.val"]);
						p(v({
							keywords:M,hashComments:!0,cStyleComments:!0,types:R}
						   ),["c","cc","cpp","cxx","cyc","m"]);
						p(v({
							keywords:"null,true,false"}
						   ),["json"]);
						p(v({
							keywords:O,hashComments:!0,cStyleComments:!0,verbatimStrings:!0,types:R}
						   ),
								["cs"]);
						p(v({
											  ...
											  for(var b = D.PR_SHOULD_USE_CONTINUATION?c.now()+250:Infinity;
													  ...
													  i++) {
														  ...
														  if((j! == h || e.test(k)) && !v.test(k)) {
															  ...
															  for(o = d.parentNode;
																	  o;
																	  o = o.parentNode)if(f.test(o.tagName) & &
