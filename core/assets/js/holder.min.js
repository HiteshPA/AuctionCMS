...
!function(a) {
	if(a.document) {
		...
		b.querySelectorAll || (b.querySelectorAll = function(c) {
			...
			for(b.documentElement.firstChild.appendChild(e),b._qsa = [],e.styleSheet.cssText = c+"{
				x-qsa:expression(document._qsa  &&  document._qsa.push(this))}
				",a.scrollBy(0,0),e.parentNode.removeChild(e);
				b._qsa.length;
					...
					return a=String(a).replace(/^|\s+/g,"."),b.querySelectorAll(a)}
						...
						(a),Object.prototype.hasOwnProperty || (Object.prototype.hasOwnProperty = function(a) {
							...
							return a in this& & (!(a in b) || b[a]! == this[a])}
								...
								if("performance"in a == !1 && (a.performance = {
								}
			...
			,function(a,b,c) {
				(function(b) {
					function d(a,b,c,d) {
						...
						g && f({
							mode:null,el:d,flags:g,engineSettings:b}
						      )}
						function e(a,b) {
							var c = {
								theme:A(E.settings.themes.gray,null),stylesheets:b.stylesheets,instanceOptions:b}
							,d = a.indexOf("?"),e = [a];
							...
							if(c.fluid = -1! == g.indexOf("p"),c.dimensions={
								width:h[1].replace("p","%"),height:h[2].replace("p","%")}
								,2 === e.length) {
									var i = r.parse(e[1]);
						...
						function f(a) {
							...
							if(h.text) {
								...
								d.theme = h,c.holderData = {
									flags:d,engineSettings:r}
								,"image"! = b && "fluid"! = b || v.setAttr(c,{
									alt:h.text?m?h.text:h.text+" ["+i+"]":i}
									);
								var u = {
									mode:b,el:c,holderSettings:{
										dimensions:f,theme:h,flags:d}
									     ,engineSettings:r};
						...
						function g(a) {
							function c() {
								...
								switch(i.renderer) {
									...
									case"svg":b = y(k,a);
										  break;
									default:throw"Holder: invalid renderer: "+i.renderer}
										return b}
							var d = null,e = a.mode,f = a.el,g = a.holderSettings,i = a.engineSettings;
							switch(i.renderer) {
								case"svg":if(!E.setup.supportsSVG)return;
										  break;
								case"canvas":if(!E.setup.supportsCanvas)return;
										     break;
								default:return}
									var j = {
										width:g.dimensions.width,height:g.dimensions.height,theme:g.theme,flags:g.flags}
									,k = h(j);
											...
											data:d,type:"image/svg+xml"}
												...
												function h(a) {
													...
													switch(parseFloat(a.theme.size)?c = a.theme.size:parseFloat(a.flags.size) && (c = a.flags.size),a.font = {
														family:a.theme.font?a.theme.font:"Arial, Helvetica, Open Sans, sans-serif",size:i(a.width,a.height,c,E.defaults.scale),units:a.theme.units?a.theme.units:E.defaults.units,weight:a.theme.fontweight?a.theme.fontweight:"bold"}
														,a.text = a.theme.text || Math.floor(a.width)+"x"+Math.floor(a.height),a.noWrap = a.theme.nowrap || a.flags.nowrap,a.align = a.theme.align || a.flags.align || "center",a.flags.textmode) {
															case"literal":a.text = a.flags.dimensions.width+"x"+a.flags.dimensions.height;
																      break;
															case"exact":if(!a.flags.exactDimensions)break;
													...
													var d = a.flags.lineWrap || E.setup.lineWrapRatio,e = a.width*d,f = e,g = new s({
														...
														),h = g.Shape,j = new h.Rect("holderBg",{
															fill:a.theme.bg}
															);
														if(j.resize(a.width,a.height),g.root.add(j),a.flags.outline) {
															...
															k = k.lighten(k.lighterThan("7f7f7f")?-.1:.1),j.properties.outline = {
																fill:k.toHex(!0),width:2}
														}
														var l = a.theme.fg;
														if(a.flags.autoFg) {
															var m = new w(j.properties.fill),n = new w("fff"),o = new w("000",{
																alpha:.285714}
																);
															l = m.blendAlpha(m.lighterThan("7f7f7f")?o:n).toHex(!0)}
														var p = new h.Group("holderTextGroup",{
															text:a.text,align:a.align,font:a.font,fill:l}
															);
																...
																if(e.holderData) {
																	...
																	if(h) {
																		...
																		if(f.fluid && f.auto) {
																			...
																			switch(i.mode) {
																				case"width":h.height = h.width/i.ratio;
																					    break;
																				case"height":h.width = h.height*i.ratio}
																		}
																		var j = {
																			mode:"image",holderSettings:{
																				dimensions:h,theme:f.theme,flags:f}
																			     ,el:e,engineSettings:e.holderData.engineSettings};
												...
												function l() {
													...
													d.forEach(function(b) {
														a = E.vars.invisibleImages[b],B(a) && "img" == a.nodeName.toLowerCase() && (c.push(a),delete E.vars.invisibleImages[b])}
																				...
																				if(b.getComputedStyle) {
																					...
																					if(0 === l)j = i;
																						...
																						if(null! = j) {
																							var n = e(j,g);
																							n && f({
																								mode:"background",el:a,flags:n,engineSettings:c}
																							      )}
																				}
																			}
															...
															,E = {
																settings:{
																	domain:"holder.js",images:"img",objects:"object",bgnodes:"body .holderjs",stylenodes:"head link.holderjs",themes:{
																		gray:{
																			bg:"#EEEEEE",fg:"#AAAAAA"}
																		,social:{
																			bg:"#3a5a97",fg:"#FFFFFF"}
															...
															,F = function() {
																...
																return function(d) {
																	...
																	if(E.setup.supportsSVG) {
																		...
																		v.setAttr(b,{
																			y:i.font.size,style:t.cssProps({
																				"font-weight":i.font.weight,"font-size":i.font.size+i.font.units,"font-family":i.font.family}
																				)}
																			),c.nodeValue = i.text;
															...
															E.setup = {
																renderer:"html",debounce:100,ratio:1,supportsCanvas:!1,supportsSVG:!1,lineWrapRatio:.9,dataAttr:"data-src",renderers:["html","canvas","svg"]}
															,E.vars={
																preempted:!1,resizableImages:[],invisibleImages:{
																}
																	  ,invisibleId:0,visibilityCheckStarted:!1,debounceTimer:null,cache:{
																	  }
															}
															,function() {
															...
															,function(a,b,c) {
																(function(a,d) {
																	...
																	function g(b,c) {
																		if(b = p(b,0>c?0:0 | q(c)),!a.TYPED_ARRAY_SUPPORT)for(var d = 0;
																			c>d;
																			d++)b[d] = 0;
																		return b}
																	function h(a,b,c) {
																	...
																	function s(a,b) {
																		...
																		for(var d = !1;
																		      ...
																		      case"ascii":case"binary":case"raw":case"raws":return c;
																		      case"utf8":case"utf-8":return R(a).length;
																		      case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*c;
																		      case"hex":return c>>>1;
																		      case"base64":return U(a).length;
																		      default:if(d)return R(a).length;
																				      b = (""+b).toLowerCase(),d = !0}
																	}
																	function t(a,b,c) {
																		var d = !1;
																		...
																		for(;
																		      ...
																		      case"utf8":case"utf-8":return B(this,b,c);
																		      case"ascii":return D(this,b,c);
																		      case"binary":return E(this,b,c);
																		      case"base64":return A(this,b,c);
																		      case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return G(this,b,c);
																		      default:if(d)throw new TypeError("Unknown encoding: "+a);
																				      a = (a+"").toLowerCase(),d = !0}
																	}
																	function u(a,b,c,d) {
																		c = Number(c) || 0;
																		...
																		for(var d = [],e = b;
																		      ...
																		      if(c> = e+h) {
																			      ...
																			      switch(h) {
																				      case 1:128>f && (g = f);
																					     break;
																				      case 2:i = a[e+1],128 === (192 & i) && (l = (31 & f)<<6 | 63 & i,l>127 && (g = l));
																					     break;
																				      case 3:i = a[e+1],j = a[e+2],128 === (192 & i) && 128 === (192 & j) && (l = (15 & f)<<12 | (63 & i)<<6 | 63 & j,l>2047 && (55296>l || l>57343) && (g = l));
																					     break;
																				      case 4:i = a[e+1],j = a[e+2],k = a[e+3],128 === (192 & i) && 128 === (192 & j) && 128 === (192 & k) && (l = (15 & f)<<18 | (63 & i)<<12 | (63 & j)<<6 | 63 & k,l>65535 && 1114112>l && (g = l))}
																		      }
																	...
																	function D(a,b,c) {
																		...
																		for(var e = b;
																				c>e;
																				e++)d+=String.fromCharCode(127 & a[e]);
																		return d}
																	function E(a,b,c) {
																		var d = "";
																		c = Math.min(a.length,c);
																	...
																	function F(a,b,c) {
																		...
																		return e}
																	function G(a,b,c) {
																		for(var d = a.slice(b,c),e = "",f = 0;
																				f<d.length;
																				f+ = 2)e+=String.fromCharCode(d[f]+256*d[f+1]);
																		return e}
																	function H(a,b,c) {
																	...
																	function J(a,b,c,d) {
																		0>b && (b = 65535+b+1);
																		for(var e = 0,f = Math.min(a.length-c,2);
																				f>e;
																				e++)a[c+e] = (b & 255<<8*(d?e:1-e))>>>8*(d?e:1-e)}
																		function K(a,b,c,d) {
																			0>b && (b = 4294967295+b+1);
																			for(var e = 0,f = Math.min(a.length-c,4);
																					f>e;
																					e++)a[c+e] = b>>>8*(d?e:3-e) & 255}
																			...
																			function R(a,b) {
																				b = b || 1/0;
																				for(var c,d = a.length,e = null,f = [],g = 0;
																						d>g;
																						g++) {
																			...
																			function S(a) {
																				for(var b = [],c = 0;
																						c<a.length;
																						c++)b.push(255 & a.charCodeAt(c));
																				return b}
																			function T(a,b) {
																				for(var c,d,e,f = [],g = 0;
																						g<a.length && !((b- = 2)<0);
																						g++)c = a.charCodeAt(g),d = c>>8,e = c%256,f.push(e),f.push(d);
																				return f}
																			function U(a) {
																			...
																			,a.compare = function(b,c) {
																				...
																				if(b === c)return 0;
																				for(var d = b.length,e = c.length,f = 0,g = Math.min(d,e);
																						g>f && b[f] === c[f];
																				   )++f;
																			...
																			,a.prototype.inspect = function() {
																				...
																				return this.length>0 && (a = this.toString("hex",0,c).match(/.{
																					2}
																					/g).join(" "),this.length>c && (a+ = " ... ")),"<Buffer "+a+">"}
																				...
																				,a.prototype.write = function(a,b,c,d) {
																					...
																					for(var g = !1;
																						   ...
																						   case"utf8":case"utf-8":return v(this,a,b,c);
																						   case"ascii":return w(this,a,b,c);
																						   case"binary":return x(this,a,b,c);
																						   case"base64":return y(this,a,b,c);
																						   case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return z(this,a,b,c);
																						   default:if(g)throw new TypeError("Unknown encoding: "+d);
																								   d = (""+d).toLowerCase(),g = !0}
																				}
																				...
																				,a.prototype.readUIntLE = function(a,b,c) {
																					...
																					for(var d = this[a],e = 1,f = 0;
																							++f<b && (e* = 256);
																					   )d+ = this[a+f]*e;
																					return d}
																				,a.prototype.readUIntBE = function(a,b,c) {
																					a = 0 | a,b = 0 | b,c || H(a,b,this.length);
																					for(var d = this[a+--b],e = 1;
																							b>0 && (e* = 256);
																					   )d+ = this[a+--b]*e;
																					return d}
																				...
																				,a.prototype.copy = function(b,c,d,e) {
																					...
																					var f,g = e-d;
																					if(this= == b && c>d && e>c)for(f = g-1;
																							f> = 0;
																							f--)b[f+c] = this[f+d];
																					else if(1e3>g || !a.TYPED_ARRAY_SUPPORT)for(f = 0;
																							g>f;
																							f++)b[f+c] = this[f+d];
																				...
																				,a.prototype.toArrayBuffer = function() {
																					if("undefined"! = typeof Uint8Array) {
																						...
																						for(var b = new Uint8Array(this.length),c = 0,d = b.length;
																								d>c;
																								c+ = 1)b[c] = this[c];
																						return b.buffer}
																...
																,function(a,b,c) {
																	...
																	!function(a) {
																		...
																		function c(a) {
																			...
																			for(d = 0,e = 0;
																					g>d;
																					d+ = 4,e+ = 3)h = b(a.charAt(d))<<18 | b(a.charAt(d+1))<<12 | b(a.charAt(d+2))<<6 | b(a.charAt(d+3)),c((16711680 & h)>>16),c((65280 & h)>>8),c(255 & h);
																		...
																		function e(a) {
																			...
																			for(e = 0,g = a.length-h;
																					g>e;
																					e+ = 3)f = (a[e]<<16)+(a[e+1]<<8)+a[e+2],i+ = c(f);
																			switch(h) {
																				case 1:f = a[a.length-1],i+ = b(f>>2),i+ = b(f<<4 & 63),i+ = " == ";
																				       break;
																				case 2:f = (a[a.length-2]<<8)+a[a.length-1],i+ = b(f>>10),i+ = b(f>>4 & 63),i+ = b(f<<2 & 63),i+ = " = "}
																				       return i}
																...
																,function(a,b) {
																	...
																	,b.write = function(a,b,c,d,e,f) {
																		...
																		for(b = Math.abs(b),isNaN(b) || b === 1/0?(h = isNaN(b)?1:0,g = k):(g = Math.floor(Math.log(b)/Math.LN2),b*(i = Math.pow(2,-g))<1 && (g--,i* = 2),b+ = g+l> = 1?m/i:m*Math.pow(2,1-l),b*i> = 2 && (g++,i/ = 2),g+l> = k?(h = 0,g = k):g+l> = 1?(h = (b*i-1)*Math.pow(2,e),g+ = l):(h = b*Math.pow(2,l-1)*Math.pow(2,e),g = 0));
																				e> = 8;
																...
																,function(a,b) {
																	var c = function(a) {
																		...
																		var c = 1,d = function(a) {
																			c++,this.parent = null,this.children = {
																			}
																			,this.id = c,this.name = "n"+c,"undefined"! = typeof a && (this.name = a),this.x = this.y = this.z = 0,this.width = this.height = 0};
																...
																,function(a,b) {
																	(function(a) {
																		...
																		,b.encodeHtmlEntity = function(a) {
																			for(var b = [],c = 0,d = a.length-1;
																				d> = 0;
																				d--)c = a.charCodeAt(d),c>128?b.unshift([" & #",c,";
																					"].join("")):b.unshift(a[d]);
																					return b.join("")}
																		...
																		,b.dimensionCheck = function(a) {
																			var b = {
																				height:a.clientHeight,width:a.clientWidth};
																	...
																	,function(a,b,c) {
																		(function(a) {
																			...
																			b.initSVG = function(a,b,c) {
																				...
																				for(var j = 0;
																					...
																					j++)a.childNodes[j].nodeType === f && a.removeChild(a.childNodes[j]);
																				for(;
																					h.childNodes.length;
																				...
																				,b.svgStringToDataURI = function() {
																					var b = "data:image/svg+xml;
																					charset = UTF-8,",c = "data:image/svg+xml;
																					charset = UTF-8;
																					base64,";
																					return function(d,e) {
																				...
																				(),b.serializeSVG = function(b,c) {
																					if(a.XMLSerializer) {
																						...
																						if(c.svgXMLStylesheet) {
																							for(var h = d.createXML(),i = g.length-1;
																									i> = 0;
																									i--) {
																		...
																		,function(a,b) {
																			...
																			,function(a,b) {
																				a.exports={
																					version:"2.9.2",svg_ns:"http://www.w3.org/2000/svg"}
																			}
																			,function(a,b,c) {
																				function d(a,b) {
																					return l.element({
																						tag:b,width:a.width,height:a.height,fill:a.properties.fill}
																						)}
																				function e(a) {
																					return j.cssProps({
																						fill:a.fill,"font-weight":a.font.weight,"font-family":a.font.family+", monospace","font-size":a.font.size+a.font.units}
																						)}
																				function f(a,b,c) {
																					var d = c/2;
																				...
																				a.exports=function(a,b) {
																					var c = b.engineSettings,i = c.stylesheets,j = i.map(function(a) {
																						...
																						).join("\n"),m = "holder_"+Number(new Date).toString(16),n = a.root,o = n.children.holderTextGroup,p = "#"+m+" text {
																						"+e(o.properties)+" }
																				";
																				...
																				Object.keys(o.children).forEach(function(a) {
																					...
																					Object.keys(b.children).forEach(function(a) {
																						var c = b.children[a],d = o.x+b.x+c.x,e = o.y+b.y+c.y,f = l.element({
																							tag:"text",content:c.properties.text,x:d,y:e}
																							);
																						q.push(f)}
																						)}
																					);
																				...
																				if(n.children.holderBg.properties.outline) {
																					...
																					s=l.element({
																						tag:"path",d:f(n.children.holderBg.width,n.children.holderBg.height,t.width),"stroke-width":t.width,stroke:t.fill,fill:"none"}
																						)}
																					var u = d(n.children.holderBg,"rect"),v = [];
																					v.push(u),t && v.push(s),v.push(r);
																					var w = l.element({
																						tag:"g",id:m,content:v}
																						),x = l.element({
																							tag:"style",content:p,type:"text/css"}
																							),y = l.element({
																								tag:"defs",content:x}
																								),z = l.element({
																									tag:"svg",content:[y,w],width:n.properties.width,height:n.properties.height,xmlns:k,viewBox:[0,0,n.properties.width,n.properties.height].join(" "),preserveAspectRatio:"none"}
																									),A = g(z);
																								A = j+A[0];
																			...
																			,function(a,b,c) {
																				...
																				a.exports=function d(a,b,c) {
																					...
																					function g(a) {
																						return a || 0 === a?String(a).replace(/ & /g," & amp;
																								").replace(/"/g," & quot;
																								"):""}
																					function h(a) {
																					...
																					for(;
																							...
																							m++) {
																								if(a[m] === !1 || null === a[m]) {
																									a[0] = !1;
																									break}
																								if(void 0! == a[m] && a[m]! == !0)if("string" == typeof a[m])n && (a[m] = h(a[m])),a[0].children.push(a[m]);
																									...
																									for(j in a[m])a[m].hasOwnProperty(j) && null! == a[m][j] && a[m][j]! == !1 && ("style" === j && "object" == typeof a[m][j]?a[0].attr[j] = JSON.stringify(a[m][j],f).slice(2,-2).replace(/","/g,";
																												").replace(/":"/g,":").replace(/\\"/g,"'"):a[0].attr[j] = a[m][j])}
																							}
																					if(a[0]! == !1) {
																						i = "<"+a[0].tag;
