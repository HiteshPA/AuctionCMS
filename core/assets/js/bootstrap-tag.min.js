...
!function(a) {
	"use strict";
	var b = function(b,c) {
		this.element = a(b),this.options=a.extend(!0,{
		}
		,a.fn.tag.defaults,c),this.values=a.grep(a.map(this.element.val().split(","),a.trim),function(a) {
			return a.length>0}
			),this.show()};
		b.prototype = {
							...
							b.element.parent().addClass("tags-hover")}
								...
								b.skip || (b.process(),b.element.parent().removeClass("tags-hover"),b.element.siblings(".tag").removeClass("tag-important")),b.skip = !1}
								    ...
								    ,createBadge:function(b) {
									    ...
									    a("<span/>",{
										    "class":"tag"}
									     ).text(b.toString()).append(a('<button type = "button" class="close"> & times;
		...
		,a.fn.tag.defaults={
			allowDuplicates:!1,caseInsensitive:!0,autocompleteOnComma:!1,placeholder:"",source:[]}
