...
!function(a) {
	...
	,p = function(a) {
		...
		.*charset\s*=\s*utf-8/i.test(a.type)?new Blob(["\ufeff",a],{
			type:a.type}
			):a}
		,q = function(b,j) {
			b = p(b);
		...
		,k = function(a,b) {
			for(var c = j(b),e = a.buttons.exportData(b.exportOptions),f = b.fieldBoundary,g = b.fieldSeparator,h = new RegExp(f,"g"),i = b.escapeChar! == d?b.escapeChar:"\\",k = function(a) {
				...
				return b}
				,l = b.header?k(e.header)+c:"",m = b.footer && e.footer?c+k(e.footer):"",n = [],o = 0,p = e.body.length;
				p>o;
				o++)n.push(k(e.body[o]));
			return{
				str:l+n.join(c)+m,rows:n.length}
		}
		,l = function() {
			...
			className:"buttons-copy buttons-html5",text:function(a) {
				return a.i18n("buttons.copy","Copy")}
				  ,action:function(b,d,e,f) {
					  var g = k(d,f),h = g.str,i = a("<div/>").css({
			...
			className:"buttons-csv buttons-html5",available:function() {
				return b.FileReader! == d && b.Blob}
				  ...
				  ,action:function(a,b,d,e) {
					  ...
					  e.customize && (h = e.customize(h,e)),i! == !1?(i || (i = c.characterSet || c.charset),i && (i = ";
								  charset = "+i)):i = "",f(new Blob([h],{
						  type:"text/csv"+i}
				  ),g(e))}
					  ...
					  var k = "",l = e.buttons.exportData(j.exportOptions),n = function(b) {
						  for(var c = [],e = 0,f = b.length;
								  ...
								  e++)null! == b[e] && b[e]! == d || (b[e] = ""),c.push("number" == typeof b[e] || b[e].match && a.trim(b[e]).match(/^-?\d+(\.\d+)?$/) && "0"! == b[e].charAt(0)?'<c t = "n"><v>'+b[e]+"</v></c>":'<c t = "inlineStr"><is><t>'+(b[e].replace?b[e].replace(/ & (?!amp;
											  ...
											  ").replace(/</g," & lt;
											  ").replace(/>/g," & gt;
											  ").replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g,""):b[e])+"</t></is></c>");
											  return"<row>"+c.join("")+"</row>"};
					  j.header && (k+ = n(l.header));
					  for(var o = 0,p = l.body.length;
							  p>o;
							  o++)k+ = n(l.body[o]);
					  j.footer && (k+ = n(l.footer));
					  var q = new b.JSZip,r = q.folder("_rels"),s=q.folder("xl"),t = q.folder("xl/_rels"),u = q.folder("xl/worksheets");
			...
			className:"buttons-pdf buttons-html5",available:function() {
				return b.FileReader! == d && b.pdfMake}
				  ...
				  ,action:function(c,d,e,h) {
					  ...
					  for(var n = 0,o = k.body.length;
							  o>n;
							  n++)m.push(a.map(k.body[n],function(a) {
								  return{
									  text:"string" == typeof a?a:a+"",style:n%2?"tableBodyEven":"tableBodyOdd"}
							  }
							  ));
							  ...
							  var p = {
								  pageSize:h.pageSize,pageOrientation:h.orientation,content:[{
									  table:{
										  headerRows:1,body:m}
										,layout:"noBorders"}
									   ],styles:{
							  ...
							  h.message && p.content.unshift({
								  text:h.message,style:"message",margin:[0,0,0,12]}
								  ),h.title && p.content.unshift({
									  text:i(h,!1),style:"title",margin:[0,0,0,12]}
								  ...
								  ,orientation:"portrait",pageSize:"A4",header:!0,footer:!1,message:null,customize:null,download:"download"}
		,e.Buttons}
		);
