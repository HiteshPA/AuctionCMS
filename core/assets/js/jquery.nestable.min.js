...
!function(a,b,c,d) {
	function e(c,d) {
		this.w = a(b),this.el = a(c),this.options=a.extend({
		}
		,j,d),this.init()}
	...
	e.prototype = {
		init:function() {
			...
			b.reset(),b.el.data("nestable-group",this.options.group),b.placeEl = a('<div class="'+b.options.placeClass+'"/>'),a.each(this.el.find(b.options.itemNodeName),function(c,d) {
		     ...
		     ,serialize:function() {
			     ...
			     return step = function(b,c) {
				     ...
				     return f.each(function() {
					     ...
					     ,b.data()),g = b.children(d.options.listNodeName);
		     ...
		     ,reset:function() {
			     this.mouse = {
				     offsetX:0,offsetY:0,startX:0,startY:0,lastX:0,lastY:0,nowX:0,nowY:0,distX:0,distY:0,dirAx:0,dirX:0,dirY:0,lastDirX:0,lastDirY:0,distAxX:0,distAxY:0}
			     ...
			     ,collapseAll:function() {
				     ...
				     ,dragStart:function(b) {
					     ...
					     this.placeEl.css("height",g.height()),e.offsetX = b.offsetX! == d?b.offsetX:b.pageX-f.offset().left,e.offsetY = b.offsetY! == d?b.offsetY:b.pageY-f.offset().top,e.startX = e.lastX = b.pageX,e.startY = e.lastY = b.pageY,this.dragRootEl = this.el,this.dragEl = a(c.createElement(this.options.listNodeName)).addClass(this.options.listClass+" "+this.options.dragClass),this.dragEl.css("width",g.width()),g.after(this.placeEl),g[0].parentNode.removeChild(g[0]),g.appendTo(this.dragEl),a(c.body).append(this.dragEl),this.dragEl.css({
						     left:b.pageX-e.offsetX,top:b.pageY-e.offsetY}
						     );
					     var h,i,j = this.dragEl.find(this.options.itemNodeName);
					     for(h = 0;
							     h<j.length;
							     h++)i = a(j[h]).parents(this.options.listNodeName).length,i>this.dragDepth && (this.dragDepth = i)}
					     ,dragStop:function(a) {
					     ...
					     ,dragMove:function(d) {
						     ...
						     this.dragEl.css({
							     left:d.pageX-l.offsetX,top:d.pageY-l.offsetY}
