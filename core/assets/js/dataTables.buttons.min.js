	...
	(function(a,b,c,d) {
		...
		var e = a.fn.dataTable,f = 0,g = 0,h = e.ext.buttons,i = function(b,c) {
			c === !0 && (c = {
				...
				,i.defaults,c),c.buttons& & (this.c.buttons=c.buttons),this.s={
					dt:new e.Api(b),buttons:[],subButtons:[],listenKeys:"",namespace:"dtb"+f++}
				,this.dom = {
			...
			action:function(a,b) {
				...
				return b === d?c.action:(c.action = b,this)}
			       ...
			       ,destroy:function() {
				       ...
				       for(b = 0,c = f.length;
						       c>b;
						       b++)for(this.removePrep(b),d = 0,e = g[b].length;
							       e>d;
							       d++)this.removePrep(b+"-"+d);
			       ...
			       ,removeCommit:function() {
				       ...
				       for(a = d.length-1;
						       a> = 0;
						       a--)null === d[a] && (d.splice(a,1),e.splice(a,1),this.c.buttons.splice(a,1));
				       for(a = 0,b = e.length;
						       b>a;
						       a++)for(c = e[a].length-1;
							       c> = 0;
							       c--)null === e[a][c] && (e[a].splice(c,1),this.c.buttons[a].buttons.splice(c,1));
						       return this}
			       ...
			       ,toIndex:function(a) {
				       ...
				       for(b = 0,c = f.length;
						       c>b;
						       b++)if(f[b].node[0] === a)return b+"";
				       for(b = 0,c = g.length;
						       c>b;
						       b++)for(d = 0,e = g[b].length;
							       e>d;
							       d++)if(g[b][d].node[0] === a)return b+"-"+d}
							       ...
							       e._buttons| | (e._buttons=[]),e._buttons.push({
								       inst:this,name:this.c.name}
													       ...
													       if(j)if(a.isArray(j))this._buildButtons(j,c,e);
														       ...
														       if(k) {
															       ...
															       if(c.append(k.inserter),e === d?(this.s.buttons.push({
																       node:l,conf:j,inserter:k.inserter}
									       ...
									       ,_keypress:function(b,c) {
										       ...
										       for(d = 0,e = h.length;
												       e>d;
												       d++)j(h[d].conf,h[d].node);
										       for(d = 0,e = i.length;
												       e>d;
												       d++)for(f = 0,g = i[d].length;
													       g>f;
													       f++)j(i[d][f].conf,i[d][f].node)}
												       ...
												       ,_resolveExtends:function(b) {
													       var c,e,f = this.s.dt,g = function(c) {
														       ...
														       for(b = g(b);
																  ...
																  ,i,b),j && b.className! == j && (b.className = j+" "+b.className);
																  var k = b.postfixButtons;
																  if(k) {
																	  for(b.buttons| | (b.buttons=[]),c = 0,e = k.length;
																			  e>c;
																			  c++)b.buttons.push(k[c]);
																	  b.postfixButtons=null}
																  var l = b.prefixButtons;
																  if(l) {
																	  for(b.buttons| | (b.buttons=[]),c = 0,e = l.length;
																			  e>c;
																			  c++)b.buttons.splice(c,0,l[c]);
		...
		,i.instanceSelector = function(b,c) {
			...
			var d = [],e = a.map(c,function(a) {
				return a.name}
					...
					if(a.isArray(b))for(var g = 0,h = b.length;
							h>g;
							g++)f(b[g]);
		...
		,i.buttonSelector = function(b,c) {
			for(var e = [],f = function(b,c) {
				...
				a.each(c.s.buttons,function(a,b) {
					null! == b && i.push({
						node:b.node[0],name:b.conf.name}
						)}
				      ...
				      if(a.isArray(b) || b instanceof a)for(g = 0,h = b.length;
					      h>g;
					      g++)f(b[g],c);
				      else if(null === b || b === d || "*" === b)for(g = 0,h = i.length;
					      h>g;
					      g++)e.push({
						      inst:c,idx:c.toIndex(i[g].node)}
						      );
					      ...
					      e.push({
						      inst:c,idx:c.toIndex(this)}
						    )}
					      );
				      else if("object" == typeof b && b.nodeName) {
					      var m = a.inArray(b,j);
					      -1! == m && e.push({
						      inst:c,idx:c.toIndex(j[m])}
						      )}
			}
			,g = 0,h = b.length;
			h>g;
					...
					return a.i18n("buttons.collection","Collection")}
				     ,className:"buttons-collection",action:function(d,e,f,g) {
					     ...
					     if(l && "absolute" === m)g._collection.css({
						     top:l.top+5,left:l.left+5}
						     );
					     else if("absolute" === m) {
						     g._collection.css({
							     top:j.top+h.outerHeight(),left:j.left}
							     );
																...
																,c),e = function(a) {
																	...
																	,f = b.columns(d.columns).indexes().map(function(a,c) {
																		return d.format.header(b.column(a).header().innerHTML,a)}
																			...
																			).toArray():null,h = b.rows(d.rows,d.modifier).indexes().toArray(),i = b.cells(h,d.columns).render(d.orthogonal).toArray(),j = f.length,l = j>0?i.length/j:0,m = new Array(l),n = 0,o = 0,p = l;
																		p>o;
																		o++) {
																			for(var q = new Array(j),r = 0;
																					j>r;
																					r++)q[r] = d.format.body(i[n],r,o),n++;
																			m[o] = q}
																		return{
																			header:f,footer:g,body:m}
															};
