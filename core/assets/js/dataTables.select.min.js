							       ...
							       function j(b) {
								       ...
								       b.aoRowCreatedCallback.push({
									       fn:function(c,d,e) {
										       ...
										       for(h._select_selected && a(c).addClass(b._select.className),f = 0,g = b.aoColumns.length;
											       g>f;
											       f++)(b.aoColumns[f]._select_selected || h._selected_cells& & h._selected_cells[f]) && a(h.anCells[f]).addClass(b._select.className)}
										       ,sName:"select-deferRender"}
												   ...
												   function k(b,c,d,e) {
													   var f = b[c+"s"]({
														   search:"applied"}
														   ).indexes(),g = a.inArray(e,f),h = a.inArray(d,f);
													   if(b[c+"s"]({
														   selected:!0}
														   ).any() || -1! == g) {
															   if(g>h) {
													   ...
													   function m(a,b,c,d,f) {
														   var g = b.select.style(),h = b[d](f,{
															   selected:!0}
															   ).any();
														   if("os" === g)if(a.ctrlKey || a.metaKey)b[d](f).select(!h);
																   ...
																   type:"column",prop:"aoColumns"}
																	   ...
																	   o.ext.selector[b.type].push(function(a,c,e) {
																		   ...
																		   for(var i = 0,j = e.length;
																			   j>i;
																			   i++)f = a[b.prop][e[i]],(g === !0 && f._select_selected === !0 || g === !1 && !f._select_selected) && h.push(e[i]);
																		   return h}
																		   )}
															  ),o.ext.selector.cell.push(function(a,b,c) {
																  var e,f = b.selected,g = [];
																  if(f === d)return c;
																  for(var h = 0,i = c.length;
																	  i>h;
																	  h++)e = a.aoData[c[h].row],(f === !0 && e._selected_cells& & e._selected_cells[c[h].column] === !0 || f === !1 && (!e._selected_cells| | !e._selected_cells[c[h].column])) && g.push(c[h]);
																  return g}
																  );
