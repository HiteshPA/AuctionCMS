...
!function(a,b,c) {
	...
	var e,f = [],g = a.resize = a.extend(a.resize,{
	}
	),h = !1,i = "setTimeout",j = "resize",k = j+"-special-event",l = "pendingDelay",m = "activeDelay",n = "throttleWindow";
	...
	(jQuery,this),function(a) {
		...
		a.plot.plugins.push({
			init:b,options:c,name:"resize",version:"1.0"}
			)}
		(jQuery);
